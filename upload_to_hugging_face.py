...
from upsamplers.layers import ChannelNorm, LayerNorm, MinMaxScaler, ImplicitFeaturizer, CATransformer
...
# create model
config = {"dim": 384,  "color_feats": True, "n_freqs": 20, "num_heads": 4, "num_layers": 2, "num_conv_layers": 1, "lr_size": 16, "lr_pe_type": "sine"}
model = LoftUp(**config)
